...
jQuery.fn.extend({
	Page:function(type,PageClass){
		...
		if(Config.Jump){$(e).append(
			$Jump.append($("<span>到&nbsp;&nbsp;</span><input type='text'><span>&nbsp;&nbsp;页&nbsp;&nbsp;&nbsp;</span>")).append($("<input>").attr("type","button").val(Config.JumpVal).attr("title",Config.JumpVal))
		)}
	...
	$Jump.find("*[type='button']").click(function(){
		var vla=$(this).prevAll("input").val();
	...
	function style(){
		...
		var Pagecss=".pa1{display:inline;box-sizing: border-box;user-select:none;}";
		var Jumpcss=".pa2{padding-left: 20px;display:inline;box-sizing: border-box;}";
		var Page_Son=".pa1 "+page_+"{transition: all 0.30s ease-in-out;-webkit-transition: all 0.30s ease-in-out;-moz-transition: all 0.30s ease-in-out;-o-transition: all 0.30s ease-in-out;-ms-transition: all 0.30s ease-in-out;display:inline;list-style-type:none;padding: 6px 12px;cursor: pointer;border: #000 1px solid;background-color: #fff;color: #000;margin: 2px;}.pa1 "+page_+":hover{background-color:#ff0003; color:#fff;}";
		var Page_click=".page-click{background-color: #ff0003!important;color: #fff!important;}.page-click:hover{background-color:#ff0003!important;color: #fff!important;}";
		var Jumpbtn=".pa2 input[type='button']{margin-top: 9px;height:30px;background-color: #fff;cursor: pointer;display: inline-block;margin-top: 0px;border:1px solid #000;height:35px;line-height:35px;padding:0 15px;}";
		var Jumptext=".pa2 input[type='text']{margin-top: 10px;display: inline-block;border:1px solid #000;height:35px;width: 50px;}";
